...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{" "}
      <CaretDownIcon className="relative top-px ml-1 size-3 transition duration-300 group-data-popup-open/navigation-menu-trigger:rotate-180 group-data-open/navigation-menu-trigger:rotate-180 motion-reduce:transition-none" aria-hidden="true" />
    </NavigationMenuPrimitive.Trigger>
  )
}
...
function NavigationMenuIndicator({
  ...
  return (
    <NavigationMenuPrimitive.Icon
      ...
      className={cn(
        "top-full z-1 flex h-1.5 items-end justify-center overflow-hidden opacity-0 transition-opacity data-popup-open:opacity-100 motion-reduce:transition-none",
        className
      )}
      {...props}
    >
